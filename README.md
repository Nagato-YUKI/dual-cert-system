...
### V2 拓展功能
- **短信通知**：腾讯云 SMS SDK 结构 + 模拟发送模式（签名审核通过后可切换真实服务）
- **教务系统对接**：外部 API + API Key 鉴权，支持学生信息查询和证书记录同步
- **证书推荐**：基于专业+年级规则引擎，前端显示"适合我"标识
- **数据大屏**：全屏 ECharts 可视化，展示关键业务指标
- **操作日志**：审计追踪，自动记录关键操作并支持查询
...
- **V2**（2026-06-06）：拓展功能完成，新增短信通知、教务对接、证书推荐、数据大屏、操作日志
